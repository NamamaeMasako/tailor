    ...
    <div class="container">
        <nav class="my-3" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">任務</li>
            </ol>
        </nav>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <b-button variant="primary" href="/game/stage/create">新增</b-button>
                    </div>
                    <div class="card-body">
...
<script>
    ...
    export default {
        ...
        data() {
         ...
         mounted() {
            console.log('Component "stage list" mounted.')
            console.log(this)
            this.initPage()
        },
        computed: {
