...
const actions = {
    getData: async (context) => {
        context.commit('getApiSetting',{which:'getData',params:{'shopspace_no': context.state.dataList.shopspaceNo}})
    ...
    submit: async (context) => {
        context.commit('getApiSetting',{which:'submit',paraArr:[context.state.dataList.shopspaceNo]})
