    ...
    <div class="container">
        <nav class="my-3" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">店內空間</li>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <b-button variant="info" class="text-light" href="/game/shopspace/list"><i class="fa fa-arrow-left mr-1"></i>返回列表</b-button>
    ...
    export default {
        ...
        data() {
         ...
         mounted() {
            ...
            console.log(this)
            this.dataList.shopspaceNo = this.$route.params.shopspace_no
            this.initPage()
        },
        computed: {
